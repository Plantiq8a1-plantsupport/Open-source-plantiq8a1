...
(function() {
    ...
    var It = function(e, t, a) {
        var o = Tt(t.params, !1), c = "h/".concat("b", "/"), l, v, h = "".concat(o, "/cdn-cgi/challenge-platform/").concat(c, "feedback-reports/").concat(Xe(e), "/").concat(t.displayLanguage, "/").concat((v = t.params.theme) !== null && v !== void 0 ? v : t.theme, "/").concat(a);
        ...
        var e = function(n, i, r, u) {
          ...
          , _ = function(n, i) {
            ...
            if (u) {
                ...
                var E = w.cloneNode(), S;
                E.src = Rt(r, u.params.sitekey, u.params, (S = u.rcV) !== null && S !== void 0 ? S : K, !1, "b", n, _t(u)),
          ...
          , T = function(n, i) {
            ...
            var P = qr(m);
            if (P) {
                var f = Object.assign(P, i), he = f.action, re = f.cData, ke = f.chlPageData, H = f.sitekey, ae;
                ...
                if (!(!Ae || !pe)) {
                    ...
                    j.setAttribute("src", Rt(Ae, H, f, K, !1, "b", z.New, _t(et))),
                    j.onerror = function() {
                        if (Y) {
